...
void main() {
  group('VisitService visit events', () {
    ...
    test(
      'markVisited creates event and summary counters on first visit',
      () async {
    ...
    test(
      'markVisited increments revisit counters without uniquePlaces bump',
      () async {
        final place = testPlace(id: 2);
        await service.markVisited(userId: 'user-1', place: place);
        final revisit = await service.markVisited(
          userId: 'user-1',
          place: place,
        );
